...
Primitives provide the vocabulary of knowledge. Concepts provide its
language.

A Primitive represents the smallest stable unit of meaning within a
given context. Alone, it possesses identity but limited explanatory
power. Through relationship, context and composition, Primitives express
richer meaning. When those relationships become sufficiently coherent to
be recognised as a single idea, a Concept emerges.

## Key Takeaways

> A Primitive possesses identity.

> A Concept possesses meaning.

> Concepts emerge through the composition of Primitives.

> Concepts continue to evolve while preserving their recognisable
> identity.
...
A Concept answers the question, "What does this mean?"

Meaning is not contained within individual Primitives. It emerges
through relationship. The movement from Primitive to Concept represents
...
-   Definitions describe Concepts but do not create them.
-   Concepts derive meaning through relationship and context.
